...
bad_url_data = [
    ("https://www.youtube.com/watch?v=CIbJSX-biu0-abcdef"), # ID is more than 11 characters raise an exception 
    ("hhttps://www.youtube.com/watch?v=CIbJSX-biu0&t"), # no time after &t
    ("https://www.youtube.com/watch?v=CIbJSX-biu0&t==60s"),
    ("https://www.youtube.com/watch?v==CIbJSX-biu0"), # ID is more than 11 characters raise an exception 
]
